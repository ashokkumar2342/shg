            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-4 form-group">
                        ...
                        <input type="text" name="share_capital" class="form-control" maxlength="5" onkeypress='return event.charCode >= 48 && event.charCode <= 57' placeholder="Enter Share Capital" value="{{$voProfileList[0]->share_capital}}" >
                    </div>
                    <div class="col-lg-4 form-group">
                        <label for="exampleInputEmail1">Monthly Subscription Amt.</label>
                        
                        <input type="text" name="monthly_subscription_amt" class="form-control" maxlength="5" onkeypress='return event.charCode >= 48 && event.charCode <= 57' placeholder="Enter Monthly Subscription Amt." value="{{$voProfileList[0]->monthly_subscription_amt}}">
                    </div>
                    <div class="col-lg-4 form-group">
                        <label for="exampleInputEmail1">Annual Membership Fee</label>
                        
                        <input type="text" name="annual_membership_fee" class="form-control" maxlength="5" placeholder="Enter Annual Membership Fee" value="{{$voProfileList[0]->annual_membership_fee}}" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                    </div>
                    <div class="col-lg-4 form-group">
                    ...
                    <div class="col-lg-3 form-group">
                        ...
                        <input type="text" name="cc_ac_cm_name" class="form-control" placeholder="Enter CC AC CM Name" maxlength="100" value="{{$voProfileList[0]->cc_ac_cm_name}}">
                    </div>
                    <div class="col-lg-3 form-group">
            ...
            <div class="card-body">
                <div class="row"> 
                    ...
                    <div class="col-lg-4 form-group">
                        ...
                        <input type="text" name="vo_cif_accno" class="form-control" maxlength="30" minlength="9" placeholder="Enter VO CIF Account" value="{{$voProfileList[0]->vo_cif_accno}}" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                    </div>
                    <div class="col-lg-4 form-group">
