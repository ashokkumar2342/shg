                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <span class="fa fa-asterisk"></span> 
                                <input type="text" name="registration_no" class="form-control" maxlength="100" placeholder="Enter Registration No">
                            </div>
                            <div class="col-lg-4 form-group">
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <span class="fa fa-asterisk"></span> 
                                <input type="text" name="share_capital" class="form-control" maxlength="15" placeholder="Enter Share Capital">
                            </div>
                            <div class="col-lg-4 form-group">
                                <label for="exampleInputEmail1">Monthly Subscription Amt.</label>
                                <span class="fa fa-asterisk"></span> 
                                <input type="text" name="monthly_subscription_amt" class="form-control" maxlength="15" placeholder="Enter Monthly Subscription Amt.">
                            </div>
                            <div class="col-lg-4 form-group">
                                <label for="exampleInputEmail1">Annual Membership Fee</label>
                                <span class="fa fa-asterisk"></span> 
                                <input type="text" name="annual_membership_fee" class="form-control" maxlength="15" placeholder="Enter Annual Membership Fee">
                            </div>
                            <div class="col-lg-4 form-group">
                                <label for="exampleInputEmail1">formation_restructure_date</label>
                                <span class="fa fa-asterisk"></span> 
                            ...
                            <div class="col-lg-3 form-group">
                                ...
                                <span class="fa fa-asterisk"></span> 
                                <input type="text" name="cc_ac_cm_name" class="form-control" placeholder="Enter CC AC CM Name">
                            </div>
                            <div class="col-lg-3 form-group">
                                <label for="exampleInputEmail1">CC AC CM Mobile No.</label>
                                <span class="fa fa-asterisk"></span> 
                                <input type="text" name="cc_ac_cm_mobile" class="form-control" placeholder="Enter CC AC CM Mobile">
                            </div>
                            <div class="col-lg-3 form-group">
                                <label for="exampleInputEmail1">Book Keeper Name</label>
                                <span class="fa fa-asterisk"></span> 
                                <input type="text" name="book_keeper_name" class="form-control" placeholder="Enter Book Keeper Name">
                            </div>
                            <div class="col-lg-3 form-group">
                                <label for="exampleInputEmail1">Book Keeper Mobile No.</label>
                                <span class="fa fa-asterisk"></span> 
                                <input type="text" name="book_keeper_mobile" class="form-control" placeholder="Enter Book Keeper Mobile">
                            </div>
                        </div> 
                    </div> 
                    ...
                    <div class="card-body">
                        <div class="row"> 
                            <div class="col-lg-4 form-group">
                                ...
                                <span class="fa fa-asterisk"></span> 
                                <input type="text" name="vo_general_accno" class="form-control" maxlength="15" placeholder="Enter VO General Account No.">
                            </div>
                            <div class="col-lg-4 form-group">
                                <label for="exampleInputEmail1">VO General Bank Name</label>
                                <span class="fa fa-asterisk"></span> 
                                <input type="date" name="vo_gen_bank_name" class="form-control">
                            </div>
                            <div class="col-lg-4 form-group">
                                <label for="exampleInputEmail1">VO General Bank Branch</label>
                                <span class="fa fa-asterisk"></span> 
                                <input type="text" name="vo_gen_bank_branch" class="form-control" placeholder="Enter VO General Bank Branch">
                            </div>
                            <div class="col-lg-4 form-group">
                                <label for="exampleInputEmail1">VO CIF Account</label>
                                <span class="fa fa-asterisk"></span> 
                                <input type="text" name="vo_cif_accno" class="form-control" placeholder="Enter VO CIF Account">
                            </div>
                            <div class="col-lg-4 form-group">
                                <label for="exampleInputEmail1">VO CIF Bank Name</label>
                                <span class="fa fa-asterisk"></span> 
                                <input type="text" name="vo_cif_bank_name" class="form-control" placeholder="Enter Book Keeper Name">
                            </div>
                            <div class="col-lg-4 form-group">
                                <label for="exampleInputEmail1">VO CIF Bank Branch</label>
                                <span class="fa fa-asterisk"></span> 
                                <input type="text" name="vo_cif_bank_branch" class="form-control" placeholder="Enter Book Keeper Name">
                            </div>
